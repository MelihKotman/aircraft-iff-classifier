...
# RENKLER %100 SENKRONİZE EDİLDİ (Hex Kodları ve RGB Değerleri Birebir Aynı)
IFF_MAP = {
    0: ('DOST',  "#15B52A", (63, 185, 80)),
    1: ('DOST',  "#15B52A", (63, 185, 80)),
    2: ('DOST',  "#15B52A", (63, 185, 80)),
    3: ('DÜŞMAN',"#E11717", (248, 81, 73)),
    4: ('DÜŞMAN',"#E11717", (248, 81, 73)),
    5: ('DÜŞMAN',"#E11717", (248, 81, 73)),
    6: ('SİVİL', "#0B7CD3", (11, 124, 65)), # Karanlık temada net okunacak Taktiksel Sarı
}

IFF_COLORS = {
    'F-16':  "#15B52A", 'F-35': "#15B52A", 'TB2':   "#15B52A",
    'MiG-29':"#E11717", 'Su-57':"#E11717", 'Heron': "#E11717",
    'Civil': "#0B7CD3"
}
...
class IFFApp(QWidget):
    ...
    def init_ui(self):
        ...
        version = QLabel('v1.5 | Cyber-Tactical')
